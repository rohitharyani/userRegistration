...
public class ListFruitsAndVegetables extends AppCompatActivity implements View.OnClickListener{
    ...
    private void loadRecyclerViewData(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_LIST_FAV_PRODUCTS, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    adapter = new ListProductAdapter(listItemProductList, ListFruitsAndVegetables.this);
