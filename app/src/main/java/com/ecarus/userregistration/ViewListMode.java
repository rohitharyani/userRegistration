...
public class ViewListMode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBill = (TextView)findViewById(R.id.ListTotal);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i =0; i<array.length();i++){
                                ...
                                ListItemProductList item = new ListItemProductList(o.getString("category"), o.getString("productId"), o.getString("products"),
                            ...
                            adapter = new ViewProductAdapter(listItemProductList, ViewListMode.this);
