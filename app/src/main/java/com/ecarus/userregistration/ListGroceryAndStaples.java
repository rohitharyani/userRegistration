...
public class ListGroceryAndStaples extends AppCompatActivity implements View.OnClickListener{
    ...
    private void loadRecyclerViewData(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_LIST_GAS_PRODUCTS, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i =0; i<array.length();i++){
                        ...
                        ListItemProductList item = new ListItemProductList(o.getString("category"), o.getString("productId"), o.getString("productName"),o.getString("cost"),
                                o.getString("weight"),o.getString("image"),
                                o.getString("quantity"),o.getString("mfgDate"),o.getString("expDate"));
                        listItemProductList.add(item);
                    }

                    adapter = new ListProductAdapter(listItemProductList, ListGroceryAndStaples.this);
