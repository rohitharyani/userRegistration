...
public class RecommenderSimilarRatedAdapter extends RecyclerView.Adapter<RecommenderSimilarRatedAdapter.ViewHolder>{
    ...
    public RecommenderSimilarRatedAdapter(List<RecommendedList> productList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recommender_similarrated_item,parent,false);
