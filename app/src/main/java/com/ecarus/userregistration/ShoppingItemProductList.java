...
public class ShoppingItemProductList {
    ...
    public ShoppingItemProductList(String mCategory, String mProductId, String mProductName, String mProductPrice,
                                   String mProductWeight, String mProductImage, String mQuantity,
                                   String mMfg, String mExp, String mTotal) {
