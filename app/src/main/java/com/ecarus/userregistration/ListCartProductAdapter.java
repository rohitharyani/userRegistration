...
public class ListCartProductAdapter extends RecyclerView.Adapter<ListCartProductAdapter.ViewHolder>{
    private List<ListItemProductList> productList;
    private Context context;
    String date = new SimpleDateFormat("dd-MM-yyyy").format(new Date());


    public ListCartProductAdapter(List<ListItemProductList> productList, Context context) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public Button mAddProduct,mRemoveProduct;
